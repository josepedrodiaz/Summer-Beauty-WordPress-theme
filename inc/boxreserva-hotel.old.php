...
<div class="col-lg-4 box-reserva hostel">
	<div class="reserva-slide">
		...
		<div class="col-lg-6 col-lg-6-boxslidecustom box2-reservahostel">
        	...
        	<input type="hidden" name="hotel_id" value="<?php echo get_post_meta($post->ID, 'id_mini_hotel',true) ?>">
        	<input type="hidden" name="username" value="<?php echo get_post_meta($post->ID, 'usuario',true) ?>">
        	<input type="hidden" name="preco_mini_hotel" value="<?php echo get_post_meta($post->ID, 'preco_mini_hotel',true) ?>">
		...
		<div class="col-lg-6 col-lg-6-boxslidecustom">
			...
			<h3><?php _e('Ligação Internacional','El-Misti'); ?></h3>
