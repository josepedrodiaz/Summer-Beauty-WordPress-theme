...
<div id="grupos" class="contenedorInterno">
    <div class="row content">
        <div class="col-md-12" style="margin-top:30px;">
            <div class="box-gris">
                <form id="grupos" action="/wp-content/themes/El-Misti/extras/procesa-form-grupos/" method="post">
                    <div class="col-md-4 uno">
                        <div class="fila">
                            <input name="Nome" type="text" class="misti-form" placeholder="<?php _e('form-nombre','El-Misti'); ?>">
                        </div>
                        <div class="fila">
                            <input name="Sobrenome" type="text" class="misti-form" placeholder="<?php _e('form-apellido','El-Misti'); ?>">
                        </div>
                        <div class="fila">
                            <input name="Email" type="text" class="misti-form" placeholder="E-mail">
                        </div>
                        <div class="fila">
                            <input name="Telefone" type="text" class="misti-form" placeholder="<?php _e('form-telefono','El-Misti'); ?>">
                        </div>
                        <div class="fila">
                            <input name="Nacionalidade" type="text" class="misti-form" placeholder="<?php _e('form-nacionalidad','El-Misti'); ?>">
                        </div>
                    </div>
                    <div class="col-md-4 dos">
                        <div class="fila">
                            <select name="Destino" class="misti-form">
                        ...
                        <div class="fila">
                            <input name="chegada" type="text" id="form-llegada" class="misti-form" placeholder="<?php _e('form-llegada','El-Misti'); ?>">
                        </div>
                        <div class="fila">
                            <input type="text" id="form-partida" class="misti-form" placeholder="<?php _e('form-partida','El-Misti'); ?>">
                        </div>
                        <div class="fila">
                            <select name="Grupo-tipo" class="misti-form">
                        ...
                        <div class="fila">
                            <input name="Grupo-tamanho" type="number" class="misti-form" placeholder="<?php _e('form-tamanio','El-Misti'); ?>">
                        </div>
                    </div>
                    <div class="col-md-4 tres">
                        <div class="fila">
                            <textarea name="Comentarios" class="misti-form textarea" placeholder="<?php _e('form-comentarios','El-Misti'); ?>"></textarea>
                        </div>
                        <div class="fila">
                            <input name="Submit" type="submit" class="btn btn-custom boton-submit" value="<?php _e('form-enviar','El-Misti'); ?>">
                        </div>
                    </div>
                </form>
            </div>
