						...
						<?php
							...
							// se for = sim    
			   				if($preco_mini_hotel == "sim"){
								...
								echo " / $adults ";
								if($adults == "1"){ echo "Hóspede "; }else echo "Hóspedes - ";
...
<?php do_action( 'woocommerce_order_details_after_order_table', $order ); ?>
	...
	<div class="col-1 od_box1" id="customer_data">
	...
	<div class="col2-set addresses" >
		...
		<div class="col-1 od_box2" id="billing_address_div">
	...
	<?php if ( get_option( 'woocommerce_ship_to_billing_address_only' ) === 'no' && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) : ?>
		...
		<div class="col-2 od_box2" id="shipping_addr_div">
			<header class="title">
