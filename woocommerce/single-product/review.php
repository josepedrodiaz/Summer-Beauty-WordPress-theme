...
<li itemprop="reviews" itemscope itemtype="http://schema.org/Review" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<div id="comment-<?php comment_ID(); ?>" class="comment_container">
		...
		<?php //echo get_avatar( $comment, apply_filters( 'woocommerce_review_gravatar_size', '0' ), '', get_comment_author() ); ?>
		...
		<div class="comment-text">
			...
			<?php if ( $comment->comment_approved == '0' ) : ?>
				...
				<p class="meta"><em style="color:red; font-family: arial; font-style: inherit; font-size: 11px;">O SEU COMENTÁRIO ESTÁ AGUARDANDO AUTORIZAÇÃO DOS MODERADORES.</em></p>
